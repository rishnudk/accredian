...
export default function Navbar() {
  return (
    <header className="w-full bg-white shadow-sm sticky top-0 z-50">
      <nav className="flex items-center justify-between px-6 py-4 max-w-[1400px] mx-auto" aria-label="Main navigation">
        ...
        <div className="hidden lg:flex items-center gap-8 text-[15px] font-medium text-gray-800">
          ...
          <Link href="#accredian-edge" className="hover:text-blue-600 transition-colors">Accredian Edge</Link>
          <Link href="#cat" className="hover:text-blue-600 transition-colors">CAT</Link>
